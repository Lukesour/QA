...
## Owner Notes
- 背景：转码申请者；选课分散，与目标岗位JD脱节。
- 动作：按“岗位-技能-课程-项目”映射重排选课，并绑定作品输出；上传映射表截图。
- 结果：岗位关键词覆盖率从 `__OWNER_FILL_%__` 提升到 `__OWNER_FILL_%__`；可展示项目从 `__OWNER_FILL_数量__` 增至 `__OWNER_FILL_数量__`。
