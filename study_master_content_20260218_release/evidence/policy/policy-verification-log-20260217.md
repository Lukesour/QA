...
| SG | https://data.gov.sg/datasets/d_493892c2528711f5aadbb64f90bb0f8d/view | GES dataset endpoint may change by platform revision, keep owner screenshot when needed | endpoint_may_change_owner_fill | 2026-02-18 |
...
| UK | https://www.gla.ac.uk/postgraduate/dates/ | Key dates page includes September intake and January intake timeline anchors | accessible | 2026-02-18 |
...
| SG | https://www.ntu.edu.sg/admissions/graduate/cwadmissionguide | Coursework guide page includes application period examples | accessible | 2026-02-18 |
...
- Zhihu/Xiaohongshu totals still require logged-in browser capture and anti-bot signature compatibility.
- For policy conclusions, P0 pages above are already sufficient and should not be replaced by secondary sources.
- If admission windows are blocked in terminal, collect browser screenshot with timestamp and store under `evidence/sources/`.
