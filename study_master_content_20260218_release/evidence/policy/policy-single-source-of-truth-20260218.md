...
| HK | Annual migration stats | 2024 student visas/entry permits: 74,466; entrants admitted under IANG in 2024: 10,796 | https://www.immd.gov.hk/eng/publications/a_report_2024/en/appendix5.html |
...
| SG | Employment Pass watchpoint | From 2027-01-01, COMPASS pass mark rises from 40 to 45 points; COMPASS salary benchmark floor and exemption thresholds also increase | https://www.mom.gov.sg/passes-and-permits/employment-pass/eligibility |
...
| UK admission window | https://www.gla.ac.uk/postgraduate/taught/ | Programme cards expose entry months (for example January/September, some April) | verified |
...
| SG admission window | https://www.comp.nus.edu.sg/programmes/pg/misc/application/ | NUS SoC MSc admission windows on page (for example Aug 2026 intake open 2025-10-01 and close 2026-01-31) | verified |
| SG admission window | https://www.ntu.edu.sg/admissions/graduate/cwadmissionguide | NTU coursework admission guide page reachable; programme-level windows published on official page | verified |
...
| SG ROI dataset endpoint | https://data.gov.sg/datasets/d_3f00cf99ddce14f81e0dc04c140e5961/view | Endpoint may change by data.gov.sg revision; if unavailable in terminal, keep owner browser capture and timestamp | owner_fill_if_blocked |
...
- Zhihu/Xiaohongshu search totals still blocked in terminal mode because of login and anti-bot signatures.
- Home Affairs Australia archive pages can be unstable for automated parsing; keep latest owner browser evidence if terminal parser fails.
- HK ImmD pages are policy-valid and should stay P0 even when automated parsers intermittently fail.
